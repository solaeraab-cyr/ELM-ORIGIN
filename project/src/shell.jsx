...
const MENTOR_NAV_ITEMS = [
  ...
  { id: 'mentor-bookings',     label: 'Bookings',     icon: 'interviews' },
...
const TopBar = ({ openSearch, theme, setTheme, navigate, signOut, user, isMentor }) => {
          ...
          {menuOpen && (
            <>
              ...
              <div style={{
                ...
                {(isMentor ? [
                  ['mentor-profile-edit', 'Edit profile', 'user'],

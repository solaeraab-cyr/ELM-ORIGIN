...
const PLANS: {
...
}[] = [
  {
    ...
    limits: ['3 rooms / day', '2 interviews / day', '5 AI chats / month'],
    features: [
      'Public study rooms',
  ...
  },
  {
    ...
    highlight: true,
    limits: ['10 rooms / day', '10 interviews / day', '50 AI chats / month'],
    features: [
      'Everything in Free',
  ...
  },
  {
    ...
    premium: true,
    limits: ['Unlimited rooms', 'Unlimited interviews', 'Unlimited AI chats'],
    features: [
      'Everything in Pro',
...
const COMPARISON_ROWS: { label: string; free: string | boolean; pro: string | boolean; elite: string | boolean }[] = [
  ...
  { label: 'DM mentors',             free: false,           pro: true,            elite: true        },
  { label: 'Mentor sessions / month', free: '—',             pro: '2',             elite: '4'         },
  { label: 'Personal study coach',    free: false,           pro: false,           elite: true        },
  { label: 'Group masterclasses',     free: false,           pro: false,           elite: true        },
